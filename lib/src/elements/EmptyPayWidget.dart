...
class EmptyPayWidget extends StatefulWidget {
  EmptyPayWidget({
    Key key,
  }) : super(key: key);

  @override
  _EmptyPayWidgetState createState() => _EmptyPayWidgetState();
}

class _EmptyPayWidgetState extends State<EmptyPayWidget> {
  bool loading = true;
  @override
  void initState() {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Opacity(
                opacity: 0.4,
                child: Text(
                  S.of(context).dont_have_any_item_in_the_pay_list,
